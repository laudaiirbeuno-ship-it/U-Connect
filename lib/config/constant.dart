...
const Color themeDark = const Color.fromARGB(255, 13, 61, 101);
...
const String GLOBAL_URL = 'https://web.unnicatelemetria.com.br';
//const String GLOBAL_URL = 'http://192.168.0.4/devkit';

const String SERVER_URL = 'https://web.unnicatelemetria.com.br/api';
