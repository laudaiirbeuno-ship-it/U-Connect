...
import 'package:maktrogps/utils/push_notification_service.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../data/screens/dashboard.dart';
import '../data/screens/listscreenoriginal.dart';
          ...
          child: Card(
            ...
            currentIndex: _currentIndex,*/
                ...
                items: [
                  ...
                  FloatingNavbarItem(icon: Icons.map_outlined, title: 'Mapa'),
                  FloatingNavbarItem(icon: Icons.dashboard, title: 'Dash'),
                  FloatingNavbarItem(
                      icon: Icons.notifications_sharp, title: 'Eventos'),
                  FloatingNavbarItem(
