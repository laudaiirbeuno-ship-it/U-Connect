...
class _listscreen extends State<listscreenorininal>
  ...
  */
  ...
  void showPopupDeleteFavorite(index, boxImageSize) {
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          if (index < _vehiclesData.length) {
            int removeIndex = index;

            // Safely remove the item from the list.
            var removedItem = _vehiclesData.removeAt(removeIndex);

            // Use the removeItem method with an inline AnimatedListRemovedItemBuilder.
            _listKey.currentState?.removeItem(
              removeIndex,
              (BuildContext context, Animation<double> animation) {
                // Provide a widget to display during the removal animation.
            ...
            // Handle invalid index or data inconsistency.
            Fluttertoast.showToast(
