...
import 'package:maktrogps/data/screens/lockscreen.dart';
...
class _livetrack extends State<livetrack> {
...
/*    _markerList.add(LatLng(-6.168033, 106.900467));
    ...
    startLocation();
    _timerDummy =
        Timer.periodic(Duration(seconds: 20), (Timer t) => _getData());
  }
...
/*
  ...
  Future<BitmapDescriptor> _createImageLabel(
      {String iconpath = "assets/images/direction.png",
      String label = 'label',
      double fontSize = 20,
      double course = 0,
...
/*          Positioned(
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () async {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => lockscreenNew()),
                );
              },
              child: Container(
                padding: EdgeInsets.all(5),
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                // color: Colors.white,
                //color: Color(0x99FFFFFF),
                child: Image.asset("assets/speedoicon/assets_images_kmicon.png",
                    height: 20,
                    width:
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () async {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => vehicle_info()),
                );
              },
              child: Container(
                padding: EdgeInsets.all(5),
                ...
                // color: Colors.white,
                //color: Color(0x99FFFFFF),
                child: Image.asset("assets/images/icons8-info-popup-100.png",
                    height: 20,
                    width:
                        20), /*Icon(Icons.refresh,
                  color: Colors.white,
          ...
          (_statusbarLoading) ? _showStatusPopup(boxImageSize) : Container()
        ],
      ),
  ...
  Widget speedometer() {
    return Positioned(
        ...
        child: Speedometer(
          ...
          displayText: "" + speedo.toString() + " km/h",
...
/*    Fluttertoast.showToast(
    ...
    if (int.tryParse(devicelist.speed.toString())! > 0) {
      ...
      label = devicelist.name.toString() +
          ...
          ' km)';
      if (prefs.get(devicelist.deviceData!.imei.toString()) != null)
        iconpath = "assets/tbtrack/" +
            prefs.get(devicelist.deviceData!.imei.toString()).toString() +
            "toprunning.png";
    } else {
      color = Colors.red;
                                      ...
                                      child: Container(
                                        child: GestureDetector(
                                            onTap: () {
                                              if (mounted) {
                                                setState(() {
                                                  if (_statusbarLoading12) {
                                                    _statusbarLoading12 = false;
                                                  } else {
                                                    _statusbarLoading12 = true;
                                                  }
                                                });
                                              }
                                        ...
                                        child: Column(children: <Widget>[
                                          ...
                                          Text('Eng Hour',
                                              style: TextStyle(
                                                  ...
                                                  color: SOFT_GREY)),
                                          Text(
                                              '' /*+ productData.engineHours.toString()*/,
                                              style: TextStyle(
                                                  fontSize: 7,
                                                  height: 1,
                                                  color: SOFT_GREY))
