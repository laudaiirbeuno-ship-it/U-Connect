...
class _playbackselection extends State<playbackselection> {
  ...
  */
            ...
            children: <Widget>[
                  ...
                  children: [
                    Expanded(
                        child: OutlinedButton(
                            ...
                            style: ButtonStyle(
                                minimumSize:
                                    MaterialStateProperty.all(Size(0, 40)),
              ...
              Container(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text('View Playback History        ',
                      style: TextStyle(
                          color: Colors.grey,
                          //fontWeight: FontWeight.bold,
                          fontSize: 15)),
  ...
  updateMarker(deviceItems devicelist) {
    ...
    _createImageLabel(
            label: label, course: devicelist.course.toDouble(), color: color)
  ...
  void showReport() {
    if (_selectedperiod == 0) {
      StaticVarMethod.fromdate = formatDateReport(DateFormat('yyyy-MM-dd')
          .format(DateTime(
              DateTime.now().year, DateTime.now().month, DateTime.now().day)));
      StaticVarMethod.todate = formatDateReport(DateFormat('yyyy-MM-dd').format(
          DateTime(
              DateTime.now().year, DateTime.now().month, DateTime.now().day)));
      StaticVarMethod.fromtime = "00:00";
      StaticVarMethod.totime = "x:59";
