...
class _signinState extends State<signinwithbackground2> {
  ...
  void showserverDialog() {
    String serverUrl = UserRepository.getServerURL(); // Default value
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: TextField(
            ...
            onChanged: (value) {
              serverUrl = value; // Update server URL as the user types
            },
          ),
          actions: [
            TextButton(
            ...
            TextButton(
              onPressed: () {
                ...
                setState(() {
                  UserRepository.setServerURL(serverUrl); // Save server URL
                });
