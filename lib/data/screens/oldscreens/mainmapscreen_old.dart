...
import 'package:uconnect/config/apps/ecommerce/global_style.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        title: Image.asset('assets/appsicon/Logo app U-connect.png', height: 40),
    ...
    for (int i = 0; i < StaticVarMethod.devicelist.length; i++) {
      if (StaticVarMethod.devicelist[i].lat != 0) {
        ...
        _createImageLabel(
                iconpath: iconpath,
                label: label,
                course: StaticVarMethod.devicelist[i].course.toDouble(),
                color: color,
...
Future<BitmapDescriptor> getMarkerIcon(String imagePath, String infoText,
  ...
  if (_showTitle) {
    ...
    textPainter.text = TextSpan(
      text: infoText,
      style:
          TextStyle(fontSize: 30.0, fontWeight: FontWeight.w600, color: color),
    );
    textPainter.layout();
  }
