...
//  final LatLng _initialPosition = LatLng(-6.168033, 106.900467);
                          ...
                          Row(children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  (productData.driverData!.phone != null)
                                      ? _launchCaller(
                                          productData.driverData!.phone)
                                      : "";
                                  /*  Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                ...
                                child: Text(
                                    (productData.driverData!.name != null)
                                        ? productData.driverData!.name
  ...
  */
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          ...
          if (index >= 0 && index < _vehiclesData.length) {
            ...
            // Trigger the animation for the removed item.
            ...
            // Handle invalid index or unexpected issues gracefully.
            Fluttertoast.showToast(
  ...
  _launchCaller(String cell) async {
    const url = "tel:8801730431973";
