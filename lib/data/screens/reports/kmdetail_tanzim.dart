...
class _kmdetailState extends State<kmdetail_tanzim> {
  ...
  void initState() {
    ...
    _timerDummy =
        Timer(Duration(seconds: 2), () => showReport1(2, "yesterday"));
    _timerDummy =
        Timer(Duration(seconds: 4), () => showReport1(3, "2 day ago"));
  ...
  void showReport1(int _selectedperiod, String currentday) {
    ...
    if (_selectedperiod == 1) {
      ...
      fromTime = "00:00:00";
      toTime = "00:00:00";
      StaticVarMethod.fromdate = DateFormat('yyyy-MM-dd').format(DateTime(
          DateTime.now().year, DateTime.now().month, DateTime.now().day - 7));
      StaticVarMethod.todate = DateFormat('yyyy-MM-dd').format(DateTime(
