...
import 'package:maktrogps/config/Session.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Text(
                                          getTranslated(context, 'routeStart')!,
                                          style: TextStyle(
                                            fontSize: 12,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      // margin: EdgeInsets.only(top: 5),
                                      child: Text(
                                          getTranslated(context, 'routeEnd')!,
                                          style: TextStyle(
                                              fontSize: 12,
                                              //height: 0.8,
                                              // fontFamily: 'digital_font'
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      // margin: EdgeInsets.only(top: 5),
                                      child: Text(
                                          getTranslated(context, 'topSpeed')!,
                                          style: TextStyle(
                                              fontSize: 12,
                                              //height: 0.8,
                                              // fontFamily: 'digital_font'
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.only(top: 5),
                                      child: Text(
                                          getTranslated(context, 'moveTime')!,
                                          style: TextStyle(
                                            fontSize: 12,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      // margin: EdgeInsets.only(top: 5),
                                      child: Text(
                                          getTranslated(context, 'stopTime')!,
                                          style: TextStyle(
                                              fontSize: 12,
                                              //height: 0.8,
                                              // fontFamily: 'digital_font'
          ...
          const Center(
              child: Text('Sensores', style: GlobalStyle.courierTitle)),
          Divider(
            height: 32,
            // color: Colors.grey[400],
          ),
