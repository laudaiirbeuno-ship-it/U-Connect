          ...
          Container(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    Text(formatReportDate(_selectedFromDate),
                        style: TextStyle(
                          fontSize: 11,
                          color: Color(0xff8E8E8E),
                        )),
                    ClipRRect(
                        ...
                        child: Image.asset(
                          "assets/speedoicon/calendar1.png",
                          height: 20,
                          width: 20,
                          color: Color(0xff8E8E8E),
                        )),
          ...
          Container(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(formatReportTime(selectedFromTime),
                        style: TextStyle(
                          backgroundColor: Color(0xffF8F7FC),
                          fontSize: 11,
                          color: Color(0xff8E8E8E),
...
//////to time and date
          ...
          Container(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(formatReportDate(_selectedToDate),
                        style: TextStyle(
                          fontSize: 11,
                          color: Color(0xff8E8E8E),
                        )),
          ...
          Container(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(formatReportTime(selectedToTime),
                        style: TextStyle(
                          backgroundColor: Color(0xffF8F7FC),
                          fontSize: 11,
                          color: Color(0xff8E8E8E),
                    ...
                    child: OutlinedButton(
                        ...
                        style: ButtonStyle(
                          ...
                          side: MaterialStateProperty.all(
                            BorderSide(color: Color(0xff0D3D65), width: 1.0),
                          ),
                        ),
                        child: Text(
                          'Proceed',
  ...
  void showReport() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => tripinfoscreen()),
    );
