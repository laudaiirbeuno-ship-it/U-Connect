                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.only(left: 15),
                                      child: Text(
                                          getTranslated(context, 'simNumber')!,
                                          style: TextStyle(
                                            fontSize: 11,
                                            fontWeight: FontWeight.normal,
                                            color: Colors.black,
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                          '' +
                                              devicemodel.deviceData!.simNumber
                                                  .toString(),
                                          style: TextStyle(
                                            fontSize: 11,
                                            color: Color(0xff8E8E8E),
                            ...
                            children: <Widget>[
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.only(left: 15),
                                      child: Text(
                                          getTranslated(context, 'protocol')!,
                                          style: TextStyle(
                                              fontSize: 11,
                                              color: Colors.black,
                                              //height: 0.8,
                              ...
                              ClipRRect(
                                  borderRadius:
                                      BorderRadius.all(Radius.circular(4)),
                                  child: Image.asset(
                                      "assets/speedoicon/speed_meter.png",
                                      height: 20,
                                      width: 20)),
                              SizedBox(
                                width: 15,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.only(left: 15),
                                      child: Text(
                                          getTranslated(context, 'satellite')!,
                                          style: TextStyle(
                                              fontSize: 11,
                                              color: Colors.black,
                                              //height: 0.8,
...
//
//
//                     if(successState.history.items!.length >0){
...
//           ),
  ...
  Future<void> getHistory(String deviceID, String fromDate, String fromTime,
      String toDate, String toTime, String currentday) async {
  ...
  Future<PositionHistory?> getReport1(String deviceID, String fromDate,
    ...
    final response = await http
        .get(Uri.parse(StaticVarMethod.baseurlall +
            "/api/get_history?lang=en&user_api_hash=${StaticVarMethod.user_api_hash}&from_date=$fromDate&from_time=$fromTime&to_date=$toDate&to_time=$toTime&device_id=$deviceID"))
