...
//  final LatLng _initialPosition = LatLng(-6.168033, 106.900467);
  ...
  Future<BitmapDescriptor> _setSourceAndDestinationIconsgreen(
      String path) async {
    _markerDirectiongreen = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 0.1), path);
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.search,
                        color: /*Colors.black*/ _topSearchColor, size: 18),
                    suffixIcon: (_etSearch.text == '')
                        ...
                        : GestureDetector(
                            ...
                            child: Icon(Icons.close,
                                color: /*Colors.grey[500]*/ _topSearchColor,
                                size: 14)),
    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  width: 1.8,
                  color: starIndex == index ? primaryDark : primaryDark),
              borderRadius: BorderRadius.all(Radius.circular(10))),
          child: index == 0
              ? Text(txt,
                  style: TextStyle(
                      color: starIndex == index ? Colors.white : primaryDark))
              : Wrap(
                            ...
                            return Padding(
                              ...
                              child: Container(
                                ...
                                productData.sensors![index].type.toString().toLowerCase() ==
                                        'ignition'
                                    ? Image.asset("assets/saftyappicon/ignintion.png",
                                    ...
                                    : productData.sensors![index].type
                                        ...
                                        : productData.sensors![index].type
                                            ...
                                            : productData.sensors![index].type
                                                    ...
                                                    'odometer'
                                                ? Image.asset(
                                                    "assets/saftyappicon/odomenetr.png",
                                                    height: imageSize,
                                                    width: imageSize)
                                ...
                                Text(
                                    productData.sensors![index].name.toString(),
                                    style: TextStyle(
                                        fontSize: 7,
                                        height: 1.5,
                                        color: themeDark)),
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    boxShadow: [
                                      ...
                                      child: Column(children: <Widget>[
                                        Image.asset(
                                            "assets/sensorsicon/batteryon.png",
                                            height: imageSize,
                                            width: imageSize),
                                        Text('Battery',
                                            style: TextStyle(
                  ...
                  children: [
                    Expanded(
                        child: OutlinedButton(
                            ...
                            child: Row(children: <Widget>[
                              Image.asset(
                                  "assets/listviewicon/livetrackicon.png",
                                  height: 12,
                                  width: 12),
                              SizedBox(
                                width: 10,
                              ...
                              Text('  Live Track',
                                  style:
                                      TextStyle(fontSize: 9, color: SOFT_GREY))
                            ])
                            /*Text(
                              'Live Track',
                              style: TextStyle(
                    ...
                    Expanded(
                        child: OutlinedButton(
                            ...
                            child: Row(children: <Widget>[
                              Image.asset("assets/listviewicon/playback.png",
                                  height: 12, width: 12),
                              SizedBox(
                                width: 10,
                              ),
                    ...
                    Expanded(
                        child: OutlinedButton(
                            ...
                            child: Row(children: <Widget>[
                              ...
                              Image.asset("assets/listviewicon/dashboard.png",
                                  height: 12, width: 12),
                              SizedBox(
                                width: 10,
                              ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Image.asset("assets/listviewicon/appsetting.png",
                            height: 15, width: 15),
  ...
  Widget googlemap(lat, lng, course, imei, speed) {
    ...
    if (speed > 0) {
      ...
      if (StaticVarMethod.pref_static!.get(imei.toString()) != null)
        iconpath = "assets/speedoicon/" +
            StaticVarMethod.pref_static!.get(imei.toString()).toString() +
            "grn.png";
    } else {
                    ...
                    child: GoogleMap(
                      ...
                      markers: <Marker>{
                        _allMarker[MarkerId(imei)] = Marker(
                            ...
                            rotation: course!,
                            icon:
                                (speed! > 0) ? snapshot.data! : snapshot.data!,
                          ...
                          children: <Widget>[
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  //color: Color(0x99FFFFFF),
                                  child: Column(children: <Widget>[
                                    Image.asset("assets/speedoicon/car.png",
                                        height: imageSize, width: imageSize),
                                    Text('Vehicle info Info',
                                        style: TextStyle(
                                          fontSize: 10,
                                          height: 2.0,
                                          color: Color(0xff8E8E8E),
                      ...
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: Container(
                              ...
                              //color: Color(0x99FFFFFF),
                              child: Column(children: <Widget>[
                                Image.asset("assets/speedoicon/speed_meter.png",
                                    height: imageSize, width: imageSize),
                                Text(
                                  'KM Summary',
                                  style: TextStyle(
                      ...
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: Container(
                              ...
                              //color: Color(0x99FFFFFF),
                              child: Column(children: <Widget>[
                                Image.asset("assets/speedoicon/engine.png",
                                    height: imageSize, width: imageSize),
                                Text('Engine Hours',
                                    style: TextStyle(
                                      fontSize: 10,
                      ...
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: Container(
                              ...
                              //color: Color(0x99FFFFFF),
                              child: Column(children: <Widget>[
                                Image.asset("assets/images/signals.png",
                                    height: imageSize, width: imageSize),
                                Text('Sensors Duration',
                                    style: TextStyle(
                                      fontSize: 10,
                                      height: 2.0,
                                      color: Color(0xff8E8E8E),
  ...
  void showPopupDeleteFavorite(index, boxImageSize) {
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          ...
          if (index >= 0 && index < _vehiclesData.length) {
            int removeIndex = index;

            // Remove the item from the data source.
            var removedItem = _vehiclesData.removeAt(removeIndex);

            // Use the AnimatedList's removeItem method to handle the animation.
            _listKey.currentState?.removeItem(
              removeIndex,
              (BuildContext context, Animation<double> animation) {
                // Provide the widget to display during the animation.
            ...
            // Handle cases where the index is invalid or the item does not exist.
            Fluttertoast.showToast(
              msg: 'Failed to delete the item. Please try again.',
              toastLength: Toast.LENGTH_SHORT,
            );
          }
        },
