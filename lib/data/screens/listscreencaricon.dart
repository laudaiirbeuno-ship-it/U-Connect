...
//  final LatLng _initialPosition = LatLng(-6.168033, 106.900467);
  ...
  void initState() {
    ...
    _getData();
    _timerDummy =
        Timer.periodic(Duration(seconds: 10), (Timer t) => _getData());
    super.initState();
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: (_searchEnabled)
            ...
            : /*Center(child: Text("List of Vehicles")),*/ Image.asset(
                'assets/appsicon/trackon.png',
                height: 40),
...
*/
  ...
  Widget _buildItem(deviceItems productData, boxImageSize, index) {
    ...
    if (productData.speed!.toInt() > 0) {
      ...
      if (prefs.get(productData.deviceData!.imei.toString()) != null)
        iconpath = "assets/speedoicon/" +
            prefs.get(productData.deviceData!.imei.toString()).toString() +
            "grn.png";
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Image.asset(
                            iconpath /*"assets/rotatingicon/2.png"*/,
                            height: boxImageSize,
                            width: boxImageSize)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            Spacer(),
                            Text("Expire on",
                                style: TextStyle(fontSize: 9, color: SOFT_GREY))
                          ]),
                    ...
                    Expanded(
                        child: OutlinedButton(
                            ...
                            child: Row(children: <Widget>[
                              Image.asset("assets/images/mylocationcolor.png",
                                  height: imageSize, width: imageSize),
                              Text('  Live Track',
                                  style:
                    ...
                    Expanded(
                        child: OutlinedButton(
                            ...
                            style: ButtonStyle(
                                ...
                                side: MaterialStateProperty.all(
                                  BorderSide(color: SOFT_GREY, width: 0.5),
                                )),
                            child: Row(children: <Widget>[
  ...
  void showPopupDeleteFavorite(index, boxImageSize) {
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          ...
          // Safely remove the item from the data list and store it for animation purposes.
          if (removeIndex < _vehiclesData.length) {
            var removedItem = _vehiclesData.removeAt(removeIndex);

            // Use AnimatedList's removeItem to handle the animation.
            _listKey.currentState?.removeItem(
              removeIndex,
              (BuildContext context, Animation<double> animation) {
                // Return the widget to display during the removal animation.
            ...
            // Handle the edge case where the index is invalid (e.g., concurrency issue).
            Fluttertoast.showToast(
