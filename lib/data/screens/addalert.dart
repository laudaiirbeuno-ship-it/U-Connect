...
class _vehicle_infoState extends State<addalert> {
                          ...
                          Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: 'Limite de velocidade',
                                  labelStyle:
                                      TextStyle(color: Colors.grey[500]),
                                ),
                              )),
            ...
            child: TextButton(
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.resolveWith<Color>(
                    (Set<MaterialState> states) => Color(0xff777777),
                  ),
  ...
  _emaillaunchURL() async {
    final url =
        Uri.encodeFull('mailto:infosbd32@gmail.com?subject=News&body=hey');
    //  final url = '';
  ...
  Future<void> savealert() async {
    ...
    var response =
        await gpsapis.addalert(name, type, StaticVarMethod.deviceId, overspeed);

    Fluttertoast.showToast(
        msg: 'Alert Added Succeessfully!!!',
