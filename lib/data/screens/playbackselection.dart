...
class _playbackselection extends State<playbackselection> {
  ...
  */
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(getTranslated(context, 'viewPlayback')!,
                      style: TextStyle(
                          color: Colors.grey,
                          //fontWeight: FontWeight.bold,
                          fontSize: 15)),
  ...
  updateMarker(deviceItems devicelist) {
    try {
      _initialPosition =
          LatLng(devicelist.lat!.toDouble(), devicelist.lng!.toDouble());
    } catch (Ex) {
      print(Ex);
      ...
      _createImageLabel(
        ...
        _allMarker[MarkerId(devicelist.deviceData!.imei.toString())] = Marker(
            ...
            onTap: () {
              ...
              StaticVarMethod.imei = devicelist.deviceData!.imei.toString();
              setState(() {
