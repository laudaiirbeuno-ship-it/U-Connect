          ...
          child: Stack(
            children: <Widget>[
              ...
              Container(
                  ...
                  padding: EdgeInsets.fromLTRB(20, 100, 0, 100),
                  alignment: Alignment.topCenter,
                  child: Image.asset(StaticVarMethod.splashimageurl,
                      height:
                          60) /*Image.asset('assets/appsicon/btplloginlogo.png', height: 90)*/
              ...
              ListView(
                children: <Widget>[
                  ...
                  Card(
                    ...
                    elevation: 5,
                    margin: EdgeInsets.fromLTRB(25, 200, 25, 0),
                    color: Colors.white,
                    child: Container(
      ...
      children: [
        Expanded(
          child: GestureDetector(
            ...
            child: Container(
              ...
              Image.asset("assets/speedoicon/assets_images_vehicleicon.png",
                  height: 30, width: 30),
              Text('  Demo  ',
                  style: TextStyle(
                      fontSize: 12,
        ...
        Expanded(
          child: GestureDetector(
            ...
            child: Container(
                child: Column(children: <Widget>[
              Image.asset("assets/nepalicon/Car-Sharing.png",
                  height: 40, width: 40),
              Text('  Register Now ',
                  style: TextStyle(
                      fontSize: 12,
