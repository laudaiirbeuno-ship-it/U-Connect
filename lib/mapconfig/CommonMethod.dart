...
String formatTime(String time) {
  ...
  return DateFormat('MM-dd-yyyy hh:mm:ss aa').format(lastUpdate.toLocal());
...
String convertSpeed(var speed) {
  double factor = 1.6093;
  double floatSpeed = speed * factor; // Multiply by the factor
  return floatSpeed.toInt().toString() + " km/ h";
}
